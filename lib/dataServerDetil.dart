...
class DetilDataServer extends StatefulWidget {
  const DetilDataServer({Key? key}) : super(key: key);

  @override
  _DetilDataServerState createState() => _DetilDataServerState();
}

class _DetilDataServerState extends State<DetilDataServer> {
 ...
 try {
    ...
    FormData formData = new FormData.fromMap({
      "idScan": idScanPanggil,
    });

    Response response = await dio.post(
      ip + "detilDataServer.php", //endpoint api Login
      data: formData,
                      ...
                      if (!snapshot.hasData) {
                        ...
                        return ListView.builder(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              return InkWell(
                                onTap: () {
                                  idBarangQR = listData[index]["kodeBarang"];
                                  idScanQR = listData[index]["idScan"];
                                  namaBarangQR = listData[index]["namaBarang"];
                                  Navigator.of(context).push(MaterialPageRoute(
                                      builder: (context) =>
                                          (const DetilDataServerQR())));
                                },
