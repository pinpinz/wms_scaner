...
class DataServer extends StatefulWidget {
  const DataServer({Key? key}) : super(key: key);

  @override
  _DataServerState createState() => _DataServerState();
}

class _DataServerState extends State<DataServer> {
  @override
  void initState() {
  ...
  Future _fetchListItems() async {
    ...
    Response response = await dio.post(
      ip + "dataServer.php", //endpoint api Login
      data: formData,
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              return InkWell(
                                onTap: () {
                                  ...
                                  sitePanggil = listData[index]["lokasi"];
